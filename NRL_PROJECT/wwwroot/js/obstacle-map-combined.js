/**
 * ObstacleMapManager - Combined Version
 * All modules combined into a single file for easier deployment and organization.
 */
...
class DraftManager {
     ...
     * @param {object} data - Object containing comment and geoJson strings.
     */
    save(data) {
...
class UIController {
    ...
    setupEventListeners() {
        ...
        // Clear placeholder text when user starts typing (if applicable)
...
class ObstacleMapManager {
    ...
    setupDrawingHandlers() {
        ...
        this.mapController.on('pm:create', (e) => {
            ...
            // NEW LOGIC: Show the submit button immediately after drawing
            this.ui.updateSubmitVisibility();

            // Auto-open comment sheet after drawing (User requirement)
    ...
    setupButtonHandlers() {
        ...
        this.ui.getButton('locate')?.addEventListener('click', () => {
            this.ui.resetActiveButtons();
            this.geolocation.locate(false); // Do not center view immediately
        });
    ...
    restoreDraft() {
        ...
        // NEW LOGIC: Ensure the submit button is visible after draft restore
        this.ui.updateSubmitVisibility();
    }

    /**
     * Reset the entire obstacle report state.
     */
    resetReport() {
        this.draftManager.disable();
        this.draftManager.clear();
